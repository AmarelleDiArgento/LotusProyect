...
begin
select CCAntes,CCDespues,CCUsuarios from permiso where CCId=cCId;
end $$
delimiter $$ 
...
delimiter $$
create procedure usuarioIn (in usuNombre varchar(45), in usuApellido varchar(45),in usuLoger varchar(15),in usuPassword varchar(255),in usuExtencion varchar(4), in usuTelefono varchar(10),in usuEmail	varchar(60), in usuEstado tinyint(1),in rolId int(11))
begin
insert into usuario (UsuNombre,UsuApellido,UsuLoger,UsuPassword,UsuExtencion,UsuTelefono,UsuEmail,UsuEstado,RolId) values (usuNombre,usuApellido,usuLoger,usuPassword,usuExtencion,usuTelefono,usuEmail,usuEstado,rolId);
end $$    
 delimiter $$
...
delimiter $$
create procedure usuarioMo (in usuNombre varchar(45), in usuApellido varchar(45),in usuLoger varchar(15),in usuPassword varchar(255),in usuExtencion varchar(4), in usuTelefono varchar(10),in usuEmail	varchar(60), in usuEstado tinyint(1),in rolId int(11))
begin
update usuario SET UsuCedula=usuCedula, UsuNombre=usuNombre,UsuApellido=usuApellido,UsuLoger=usuLoger,UsuPassword=usuPassword,UsuExtencion=usuExtencion,UsuTelefono=usuTelefono,UsuEmail=usuEmail,UsuEstado=usuEstado,RolId=rolId  where UsuCedula=usuCedula;
end $$
delimiter $$
...
delimiter $$
create procedure usuarioCo (in tId INT)
begin
select UsuNombre,UsuApellido,UsuLoger,UsuPassword,UsuExtencion,UsuTelefono,UsuEmail,UsuEstado,RolId from usuario where UsuCedula = usuCedula;
end $$
delimiter $$
...
delimiter $$
create procedure usuarioEl (in usuCedula INT)
begin
delete from usuario where  UsuCedula = usuCedula;
end $$
delimiter $$
