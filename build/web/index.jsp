...
<html lang="es">
    ...
    <body>
        <header class="header">
            ...
            <div>
                <a class=" btn-session btn-floating btn-large waves-effect waves-light modal-trigger" href="#buscar"><i class="material-icons orange-text darken-3">search</i></a>
                <a class=" btn-session btn-floating btn-large  modal-trigger" href="#sesion"><i class="material-icons orange-text darken-4 ">person</i></a>
            </div>
        </header>
