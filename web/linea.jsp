...
<%@page import="Modelo.Tabs.LineaTab"%>
<%@page import="Servicios.Mensajes"%>
<%@page import="java.util.List"%>
<!DOCTYPE html>
<%
// nombrar jsp de estancia
    String jsp = "Linea.jsp";
...
<html lang="es">
    ...
    <body
        ...
        <div class="container">
            ...
            <%
                List<LineaTab> LisL = (List<LineaTab>) Ses.getAttribute("lisL");
            %>
            <table class="centered striped responsive-table" id="tabla" >
                ...
                <tbody>
                    <% for (LineaTab at : LisL) {%>
                    <tr>
                        <td><%=at.getLinId()%></td>
                        <td>
                            <label>
                                <input type="checkbox" <% if (at.isLinEstado()) {%> checked="checked" <% }%> /> 
                                <span></span>
                            </label>
                        </td>
                        ...
                        <td>
                            <a href="#">
                                <i class="material-icons purple-text" onclick="consultar(<%=at.getLinId()%>)" > edit </i>
                            </a>
                        </td>
                        <%}
                            if (acc.isRpEliminar()) {%>
                        ...
                        <td>
                            <a href="#">
                                <i class="material-icons purple-text" onclick="msjConf(<%=at.getLinId()%>)"> delete </i>
                            </a>
                        </td>
                        <%}%>
                    </tr>
        ...
        <div id="modalNuevo" class="modal modal-fixed-footer">
            <form method="get" action="lineas.do">
                <div class="modal-content">
                    <h4><i class="material-icons medium">assignment_ind</i> Nueva Linea</h4>
                    <p>Registra la informacion de la nueva Linea</p>
                    <div class="row">
        ...
        <%if (acc.isRpEditar()) {%>
        <%if (Ses.getAttribute("LIn") != null) {
                LineaTab lS = (LineaTab) Ses.getAttribute("Rol");
        %>
        <div id="modalModificar" class="modal modal-fixed-footer">
            <form method="get" action="linea.do">
                <div class="modal-content">
                    <h4><i class="material-icons medium">assignment_ind</i> Nueva Linea</h4>
                    <p>Registra la informacion de la nueva Linea</p>
                    <div class="row">
                                    ...
                                    function msjConf(id) {
                                        swal({
                                            ...
                                            dangerMode: true
                                                ...
                                                .then((willDelete) => {
                                                    if (willDelete) {
                                                        window.location = 'lineas.do?accion=Eliminar&Id=' + id;
                                                    }
                                                });
                                    }
                                    ;
...
<%
    ...
    Ses.setAttribute("lisL", null);
    Ses.setAttribute("Linea", null);
    Ses.setAttribute("msj", null);
} else {%>
<html>
    <body onload="document.getElementById('lista').submit()">
        <form id="lista" action="lineas.do" method="post" >
