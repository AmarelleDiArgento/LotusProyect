<%@page import="Modelo.Tabs.FitoProductoTab"%>
...
<html lang="es">
    <head>
        ...
        <title>Lotus QA - FitoProducto</title>
    ...
    <body
        ...
        <div class="container">
            ...
            <table class="centered striped">
                ...
                <tbody>
                    <% for (FitoProductoTab ft : LisF) {%>
                    <tr>
                        <td><%=ft.getFitId()%></td>
                        <td><%=ft.getFpArea()%></td>
                        <td><%=ft.getFpImagen()%></td>
