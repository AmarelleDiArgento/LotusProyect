            ...
            <div class="modal-content card">
                ...
                <div class="mySlides center">
                    ...
                    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4">Paso <%=pt.getPasId()%><i class="material-icons right">more_vert</i></span>
                    </div>

                </div>

                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Paso <%=pt.getPasId()%><i class="material-icons right">close</i></span>
