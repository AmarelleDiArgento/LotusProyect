...
public class ProductoMs implements Producto {
    ...
    final String Insertar = "call LotusProject.productoIn(?,?);";
    final String Modificar = "call LotusProject.preliminarMo(?,?,?);";
    final String Eliminar = "call LotusProject.productoEl(?);";
    final String Consultar = "call LotusProject.productoCo(?);";
    final String ListarTodos = "call LotusProject.productoLi();";
