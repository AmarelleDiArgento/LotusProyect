 ...
 * @author ale-j
 */
public class MaestroServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // if (Ses.getAttribute("log") != null) {
        ...
        for (AsignaPermisoTab a : ap) {
           ...
           if (acc == null) {
            m.setTipo("Error");
            m.setMsj("Maestro: Permisos insuficientes");
            ...
            switch (Accion) {
                case "Registrar":
                    if (acc.isRpNuevo()) {
                        ...
                        ma = new MaestroTab(Nombre, Descripcion);
                        m = Asql.getMaestro().insertar(ma);
                ...
                case "Modificar":
                    if (acc.isRpEditar()) {
                        ...
                        Nombre = request.getParameter("Nombre");
                        Descripcion = request.getParameter("Descripcion");
                        ma = new MaestroTab(Id, Nombre, Descripcion);
                        m = Asql.getMaestro().modificar(ma);
