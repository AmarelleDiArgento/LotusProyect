 ...
 * @author ale-j
 */
public class FitoProductoServ extends HttpServlet {
        ...
        try {
            ...
            switch (Accion) {
                ...
                case "obtener":
                    if (acc.isRpLeer()) {
                        Id = Integer.parseInt(request.getParameter("Id"));
                        fi = Asql.getFitoProducto().obtener(Id);
                        Ses.setAttribute("Fito", fi);
                        m.setMsj("Se ha obtenido el FitoProducto con id: " + fi.getFitId());
                        m.setTipo("Ok");
                    } else {
                        m.setTipo("Error");
                ...
                case "Listar":
                    //if (acc.isRpLeer()) {
                    List<FitoProductoTab> fl = Asql.getFitoProducto().listar();
